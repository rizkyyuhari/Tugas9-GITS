package com.example.tugas9_gits.Fragment;
...
import com.example.tugas9_gits.HomeActivity;
...
public class HomeFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
       ...
       recyclerView = view.findViewById(R.id.rv_list);
        ...
        list.addAll(HomeDataModel.languageList());
        showGridProjek();
        return view;
    ...
    private void showGridProjek() {
        ...
        HomeAdapter gridProjekAdapter = new HomeAdapter(list);
